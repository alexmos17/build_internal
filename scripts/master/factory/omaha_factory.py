...
"""Utility class to build the omaha main BuildFactory's.

Based on gclient_factory.py and adds omaha-specific steps."""

from main.factory import omaha_commands
from main.factory import gclient_factory


class OmahaFactory(gclient_factory.GClientFactory):
  """Encapsulates data and methods common to the Omaha main.cfg files."""
  ...
  def OmahaFactory(self, target='opt-win', tests=None,
    ...
    if (subordinate_type in ['BuilderTester', 'Builder']):
