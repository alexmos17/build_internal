...
RELOAD_ERRORS = ('C:\b\subordinate\chrome-release-snappy\build\chrome\browser'
...
SPDY_ERRORS = ('C:\b\subordinate\chrome-release-snappy\build\chrome\browser'
...
SWITCH_ERRORS = ('C:\b\subordinate\chrome-release-snappy\build\chrome\browser'
'\navigation_controller_unittest.cc:615: Failure' + """
Value of: -1
Expected: contents->controller()->GetPendingEntryIndex()
Which is: 0

""" + 'C:\b\subordinate\chrome-release-snappy\build\chrome\browser'
