  ...
  with main_cfg_utils.TemporaryMainPasswords():
    ...
    for base, mains in all_mains.iteritems():
      for main in mains[:]:
        ...
        cur_thread.start()
        main_threads.append(cur_thread)
      for cur_thread in main_threads:
        cur_thread.join(20)
...
def main(argv):
  ...
  public_mains = {
      ...
      'main.chromium.memory.fyi': 'ChromiumMemoryFYI',
      ...
      'main.client.libvpx': 'Libvpx',
      'main.client.nacl': 'NativeClient',
      'main.client.nacl.ports': 'NativeClientPorts',
      'main.client.nacl.sdk': 'NativeClientSDK',
      'main.client.nacl.sdk.addin': 'NativeClientSDKAddIn',
      'main.client.nacl.sdk.mono': 'NativeClientSDKMono',
      'main.client.nacl.toolchain': 'NativeClientToolchain',
      'main.client.pagespeed': 'PageSpeed',
      'main.client.polymer': 'Polymer',
      'main.client.sfntly': 'Sfntly',
      ...
      'main.tryserver.chromium.gpu': 'GpuTryServer',
